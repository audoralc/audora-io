      ...
      <div style={aboutBlock}>
        <Paper  zDepth={2} style={aboutTextBlockStyle}>
          <section>
              ...
              <StyledHeader> <img
                    src="http://audora.me/img/emoji/sparkles.png"
                    height="24px"
                    width="24px"
                  alt="sparkles emoji"/> Hi! <img
                    src="http://audora.me/img/emoji/sparkles.png"
                    height="24px"
                    width="24px"
                  alt="sparkles emoji"/> </StyledHeader>

              <p style={intro}> I'm Audora, a Helper & Maker of Things. </p>

              <p style={body}> Also a bootcamp grad & wannabe UI developer. Currently I work with Javascript (mainly React <svg viewBox="0 0 128 128" height="24px" width="24px" >
