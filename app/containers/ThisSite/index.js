...
export default class ThisSite extends React.PureComponent {
  render() {
    ...
    return (
      ...
      <div style={pageGrid}>
        <Helmet title="About audora.me" meta={[ { name: 'description', content: 'Description of SumoRedesign' }]}/>
        <Header></Header>
        <div style={bodyWrapper}> 
          <Paper zDepth={2}> 
            <div style={content}>            
              ...
              <h3> This site was created with 3 things in mind:</h3> <ul style={ulStyle}> 
                <li>pastel material ui,</li> 
                <li>the use of material ui's Paper component to create deconstructed 'sticky notes' on the page,</li> 
                <li>and a love of emojis. 😉</li>
              </ul>
